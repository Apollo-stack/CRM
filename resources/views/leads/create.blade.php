...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-white">Novo Negócio</h1>
    ...
    {{-- FORMULÁRIO --}}
    <form action="{{ route('leads.store') }}" method="POST" class="bg-gray-800 rounded-lg p-6">
        @csrf
        ...
        <div class="mb-4">
            ...
            <input type="text" 
                   name="title" 
                   value="{{ old('title') }}"
                   placeholder="Ex: Venda de 100 peças"
                   required
        ...
        <div class="border-t border-gray-700 pt-4 mt-6 mb-4">
            <h3 class="text-white font-bold mb-3">Endereço da Entrega (Opcional)</h3>
